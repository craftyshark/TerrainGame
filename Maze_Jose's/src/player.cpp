...
Player::Player()    //creation of player
{
    //ctor
    playerDir = "up";
    arrowLoc.x = 0.2;  // arrow bs
    arrowLoc.y =0.5;
    arrAngle =0;
    arrowStatus = false;
    livePlayer = true;   //active player?
    action= 0;
    activePlayer=false;             // no one starts off active.
}
...
void Player::drawplayer()  // actually displays the player
{
    if(livePlayer)
    {
